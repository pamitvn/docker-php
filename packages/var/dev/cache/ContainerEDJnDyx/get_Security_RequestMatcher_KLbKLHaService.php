...
class get_Security_RequestMatcher_KLbKLHaService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 5).'/vendor/symfony/http-foundation/ChainRequestMatcher.php';
        include_once \dirname(__DIR__, 5).'/vendor/symfony/http-foundation/RequestMatcher/PathRequestMatcher.php';
